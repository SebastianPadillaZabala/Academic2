...
<div class="sticky z-10 top-0 h-16 border-b lg:py-0">
        <div class="px-2 py-2 flex items-center justify-between space-x-6 2xl:container">
            <h5 hidden class="text-2xl text-gray-600 font-medium lg:block">Profesores</h5>
        ...
        @foreach($profesores as $p)
			<tr class="bg-gray-300 border border-grey-500 md:border-none block md:table-row">
				...
				<td class="p-2 md:border md:border-grey-500 text-left block md:table-cell">
					...
					<button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-2 border border-blue-500 rounded">CV</button>
