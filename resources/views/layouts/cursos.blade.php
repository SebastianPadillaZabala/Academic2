<div class="py-12 bg-gray-100">
    <div class="container flex flex-col items-center justify-center px-4 pt-2 pb-8 mx-auto sm:px-6 lg:px-8">
        ...
        <h2
            ...
            <span class="relative">Nuestros Cursos + Populares</span> </h2>
        <a href="{{route('login')}}" class="mt-3 text-sm font-semibold text-indigo-600 underline">Observa Todos Nuestros Cursos</a>

        <div class="grid max-w-lg gap-5 mx-auto mt-12 md:grid-cols-2 lg:grid-cols-3 md:max-w-none">
            <div class="flex flex-col overflow-hidden rounded-lg shadow-lg transform transition-all hover:-translate-y-4">
                    ...
                    <div class="flex items-center p-6 bg-gray-100">
                        ...
                        <div class="ml-3">
                            <p class="text-sm font-medium leading-5 text-gray-900">
                                <a href="#" class="hover:underline">Olmos Heidy</a>
                            </p>
            ...
            <div class="flex flex-col overflow-hidden rounded-lg shadow-lg transform transition-all hover:-translate-y-4">
                ...
                <div class="flex flex-col justify-between flex-1">
                    ...
                    <div class="flex items-center p-6 bg-gray-100">
                        ...
                        <div class="ml-3">
                            <p class="text-sm font-medium leading-5 text-gray-900">
                                <a href="#" class="hover:underline">Vargas Diego</a>
                            </p>
                            <div class="text-xs leading-5 text-gray-600">
            ...
            <div class="flex flex-col overflow-hidden rounded-lg shadow-lg transform transition-all hover:-translate-y-4">
                ...
                <div class="flex flex-col justify-between flex-1">
                    ...
                    <div class="flex items-center p-6 bg-gray-100">
                        ...
                        <div class="ml-3">
                            <p class="text-sm font-medium leading-5 text-gray-900">
                                <a href="#" class="hover:underline">Pillco Juan Pablo</a>
                            </p>
                            <div class="text-xs leading-5 text-gray-600">
