        ...
        <div class="flex rounded-lg shadow-lg w-full sm:w-3/4 lg:w-1/2 bg-white sm:mx-0" style="height: 500px">
            <div class="flex flex-col w-full md:w-1/2 p-4">
                <div class="flex flex-col flex-1 justify-center mb-8">
                    <h1 class="text-4xl text-center font-thin">Registrar Categoria</h1>
                    <div class="w-full mt-4">
                        <form class="form-horizontal w-3/4 mx-auto" method="POST" action="{{ route('Añadircategorias') }}">
                           @csrf
                           <div class="flex flex-col mt-4">
                                <input id="nombre" type="text" class="flex-grow h-8 px-2 border rounded border-grey-400" name="nombre" value="" placeholder="Nombre" required autofocus>
                            </div>
                            <div class="flex flex-col mt-4">
